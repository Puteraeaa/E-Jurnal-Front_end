...
function ForgotPassword(){
    ...
    return(
        <div className="min-h-screen bg-base-200 flex items-center">
            <div className="card mx-auto w-[800px] max-w-5xl  shadow-xl">
                ...
                <div className='py-24 px-10 '>
...

                    {
                        ...
                        <>
                            ...
                            <div className='text-center mt-4'><Link to="/"><button className="btn btn-block btn-primary ">Login</button></Link></div>
