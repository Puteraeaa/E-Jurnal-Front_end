...
const AddLeadPage = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-6 sm:mx-auto"> {/* Adjusted width and padding */}
            <h3 className="font-bold text-2xl sm:text-3xl text-center mb-10">Tambah Data Orang Tua</h3> {/* Updated title */}
            <form onSubmit={handleSubmit} className="max-w-lg mx-auto space-y-4"> {/* Updated form container */}
                <div className="mb-4">
                    <label className="block mb-2 font-bold">Nama Orang Tua:</label> {/* Updated label */}
                    <input
                        type="text"
                        name="name"
                        value={formData.name}
                ...
                <div className="mb-4">
                    <label className="block mb-2 font-bold">Email Orang Tua:</label> {/* Updated label */}
                    <input
                        type="email"
                        name="email"
