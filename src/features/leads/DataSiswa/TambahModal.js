...
const AddLeadModal = ({ onClose }) => {
    ...
    return (
        <div className="modal modal-open">
            <div className="modal-box w-11/12 max-w-5xl h-auto p-6 relative"> {/* Disesuaikan dengan modal Tambah Data Guru */}
                <h3 className="font-bold text-2xl sm:text-3xl text-center mb-6">Tambah Data Siswa</h3> {/* Updated title */}
